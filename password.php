...
class password {
	 ...
	 * @var array 
	 */
	private $passwordStrengthInfo = array('Very Weak', 'Weak', 'Good', 'Strong', 'Very Strong');

	/**
	 * Construct - you may set your own password policy
	 * @param array $passwordPolicy - array(lowerCharsCount => 2, upperCharsCount => 2, specialCharsCount => 2, numbersCount => 2, minimumPasswordLength => 2) 
	 */
